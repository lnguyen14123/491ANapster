import {
  ...
  d,
  p
} from "./chunk-N6JBS6A2.js";
import {
  require_pluralize
} from "./chunk-6SGWFTSZ.js";
import {
  chunk_default,
    ...
    ((e, t) => {
      ...
      function i2(m3) {
        ...
        U(m3.step) && (t = m3.step, m3.step = function(e2) {
          ...
          })(e2, m3.newline, m3.skipEmptyLines, m3.comments, m3.delimitersToGuess)).successful ? m3.delimiter = r3.bestDelimiter : (a2 = true, m3.delimiter = v.DefaultDelimiter), p4.meta.delimiter = m3.delimiter), w(m3));
      ...
      function E2(C2) {
        ...
        this.parse = function(i3, t, r2) {
          ...
          if (T3 || false !== T3 && -1 === i3.indexOf(F)) {
            for (var l3 = i3.split(O), c3 = 0; c3 < l3.length; c3++) {
              ...
              if (!x || d4.substring(0, a2) !== x) {
                if (o3) {
                  if (h2 = [], k2(d4.split(S)), R2(), M) return b();
                } else k2(d4.split(S));
                if (A3 && A3 <= c3) return h2 = h2.slice(0, A3), b(true);
              }
            }
            return b();
          }
          for (var p4 = i3.indexOf(S, z2), g3 = i3.indexOf(O, z2), _3 = new RegExp(P(j) + P(F), "g"), m3 = i3.indexOf(F, z2); ; ) if (i3[z2] === F) for (m3 = z2, z2++; ; ) {
            ...
            if (F === j && i3[m3 + 1] === j) m3++;
              ...
              if (i3.substring(m3 + 1 + y3, m3 + 1 + y3 + s2) === O) {
                if (d4.push(i3.substring(z2, m3).replace(_3, F)), w2(m3 + 1 + y3 + s2), p4 = i3.indexOf(S, z2), m3 = i3.indexOf(F, z2), o3 && (R2(), M)) return b();
                if (A3 && h2.length >= A3) return b(true);
                break;
              }
            ...
            if (-1 === g3) break;
            if (d4.push(i3.substring(z2, g3)), w2(g3 + s2), o3 && (R2(), M)) return b();
            if (A3 && h2.length >= A3) return b(true);
          }
          return E3();
          function k2(e2) {
          ...
          function E3(e2) {
            return r2 || (void 0 === e2 && (e2 = i3.substring(z2)), d4.push(e2), z2 = n2, k2(d4), o3 && R2()), b();
          }
          function w2(e2) {
...
papaparse/papaparse.min.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-EOLO7HF3.js.map
